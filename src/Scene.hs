...
demoScene = Scene [sphere0, sphere1, sphere2, plane0]
  ...
  where sphere0 = Entity (Sphere (coord 0 0 200) 20)         (mkDiffuse 0.98 0 0)
        sphere1 = Entity (Sphere (coord 5 35 200) 25)        (mkDiffuse 0 0.98 0)
        sphere2 = Entity (Sphere (coord (-25) 20 180) 10)    (mkDiffuse 0 0.98 0.98)
        plane0  = Entity (Plane (unitvec 0 0.5 (-0.5)) 150) (mkDiffuse 0.5 0.5 0.5)
        light0  = OmniLight (coord (-40) 80 0, 100 *~lumen)
